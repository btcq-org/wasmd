...
type ChannelKeeper interface {
	...
	ChanCloseInit(ctx sdk.Context, portID, channelID string) error // IBC v10: capability removed
...
type ICS4Wrapper interface {
	...
	) error // IBC v10: capability parameter removed
}
...
type PortKeeper interface {
	BindPort(ctx sdk.Context, portID string) error // IBC v10: returns error instead of capability
}

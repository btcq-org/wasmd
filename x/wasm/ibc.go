...
import (
	...
	// capabilitytypes "github.com/cosmos/ibc-go/modules/capability/types" // unused in IBC v10
	clienttypes "github.com/cosmos/ibc-go/v10/modules/core/02-client/types"
	channeltypes "github.com/cosmos/ibc-go/v10/modules/core/04-channel/types"
	porttypes "github.com/cosmos/ibc-go/v10/modules/core/05-port/types"

	// host "github.com/cosmos/ibc-go/v10/modules/core/24-host" // unused in IBC v10
...
// IBC v10: capability parameter removed
func (i IBCHandler) OnChanOpenInit(
	...
	// IBC v10: capability system removed
...
// IBC v10: added channelID parameter
func (i IBCHandler) OnTimeoutPacket(ctx sdk.Context, channelID string, packet channeltypes.Packet, relayer sdk.AccAddress) error {
	contractAddr, err := keeper.ContractFromPortID(packet.SourcePort)
	if err != nil {
		return errorsmod.Wrapf(err, "contract port id")
	}

...
var maccPerms = map[string][]string{
	...
	// ibcfeetypes.ModuleName:      nil, // removed in IBC v10
...
type WasmApp struct {
	*baseapp.BaseApp
	...
	// IBCFeeKeeper        ibcfeekeeper.Keeper // removed in IBC v10
	...
	// ScopedIBCFeeKeeper        capabilitykeeper.ScopedKeeper // removed in IBC v10
...
func NewWasmApp(
	...
	keys := storetypes.NewKVStoreKeys(
		...
		// non sdk store keys
		capabilitytypes.StoreKey, ibcexported.StoreKey, ibctransfertypes.StoreKey, // ibcfeetypes.StoreKey removed in IBC v10
	...
	*/
	...
	// IBC Fee Module keeper - removed in IBC v10
	...
	app.TransferKeeper = ibctransferkeeper.NewKeeper(
		...
		app.IBCKeeper.ChannelKeeper, // ISC4 Wrapper: was fee IBC middleware in v8
		app.IBCKeeper.ChannelKeeper,
	...
	// Create wasm ibc Stack (fee middleware removed in IBC v10)
	var wasmStack porttypes.IBCModule
	wasmStackIBCHandler := wasm.NewIBCHandler(app.WasmKeeper, app.IBCKeeper.ChannelKeeper, app.IBCKeeper.ChannelKeeper)
	wasmStack = wasmStackIBCHandler // ibcfee.NewIBCMiddleware removed in v10
	...
	// icaControllerStack = ibcfee.NewIBCMiddleware(icaControllerStack, app.IBCFeeKeeper) // removed in IBC v10
	// Since the callbacks middleware itself is an ics4wrapper, it needs to be passed to the ica controller keeper
	app.ICAControllerKeeper.WithICS4Wrapper(icaICS4Wrapper)

	// RecvPacket, message that originates from core IBC and goes down to app, the flow is:
	// channel.RecvPacket -> icaHost.OnRecvPacket (fee middleware removed in v10)
	var icaHostStack porttypes.IBCModule
	icaHostStack = icahost.NewIBCModule(app.ICAHostKeeper)
	// icaHostStack = ibcfee.NewIBCMiddleware(icaHostStack, app.IBCFeeKeeper) // removed in IBC v10
	...
	// transferStack = ibcfee.NewIBCMiddleware(transferStack, app.IBCFeeKeeper) // removed in IBC v10
	// Since the callbacks middleware itself is an ics4wrapper, it needs to be passed to the ica controller keeper
	...
	app.ModuleManager = module.NewManager(
		...
		// ibcfee.NewAppModule(app.IBCFeeKeeper), // removed in IBC v10
	...
	app.ModuleManager.SetOrderBeginBlockers(
		...
		icatypes.ModuleName,
		// ibcfeetypes.ModuleName, // removed in IBC v10
